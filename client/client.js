window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		* 之后更新目录请改 private-catalog/*.json 并推送到该仓库。 */
		...
		const BRAND = Object.freeze({
			...
			displayNameEn,
			/** 页头"回仓库"链接。 */
			repoUrl: "https://github.com/qudayan92/dsh-market",
			repoTitle: `${displayNameEn} · GitHub`,
			/** "申请收录插件"入口。 */
			submitUrl: "https://github.com/qudayan92/dsh-market/issues/new",
		...
		const zh = {
			...
			themeTagRetro: "复古",
			themeTagAnime: "动漫",
			themeTagWallpaper: "动态壁纸",
			themeTagPack: "多主题包",
			themeTagCustomizer: "自定义器",
			themeTagEmpty: "该标签下暂无主题",
		...
		const en = {
			...
			sortQuality: "Quality (editor pick)",
			badgePrebuilt: "Prebuilt",
			badgeSubpath: "Subpackage source",
			badgeSource: "Source install",
			sortDesc: "Descending",
			sortAsc: "Ascending",
			sortNewest: "Newest",
			sortOldest: "Oldest",
			...
			themeTagsLabel: "Theme style",
			themeFeatured: "Featured this week",
			themeTagDark: "Dark",
			themeTagLight: "Light",
			themeTagGlass: "Glass",
			themeTagMinimal: "Minimal",
			themeTagRetro: "Retro",
			themeTagAnime: "Anime",
			themeTagWallpaper: "Wallpaper",
			themeTagPack: "Multi-theme pack",
			themeTagCustomizer: "Customizer",
			themeTagEmpty: "No themes match this tag",
		...
		*/
		const THEME_TAG_OVERRIDES = {
			"https://github.com/zhijun-dai/Catppuccin-dsh-theme": [
				"dark",
				"light",
				"pack"
			],
			"https://github.com/zhijun-dai/Solarized-dsh-theme": [
				"dark",
				"light",
				"pack"
			],
		...
		*/
		function themeTags(plugin) {
			const override = THEME_TAG_OVERRIDES[plugin.url];
			if (override !== void 0) return [...override];
			const name = plugin.name.toLowerCase();
			const desc = (plugin.description?.en ?? "").toLowerCase();
			const tags = [];
			for (const rule of THEME_TAG_RULES) if (rule.name.test(name) || rule.desc.test(desc)) tags.push(rule.tag);
			return tags;
		}
		/**
		...
		*/
		function featuredTheme(plugins, now = /* @__PURE__ */ new Date()) {
			const candidates = FEATURED_THEMES.map((f) => ({
				f,
				plugin: plugins.find((p) => p.url === f.url)
			})).filter((x) => x.plugin !== void 0);
			if (candidates.length === 0) return null;
			return {
				plugin: candidates[isoWeek(now) % candidates.length].plugin,
				note: candidates[isoWeek(now) % candidates.length].f.note
			};
		}
		/**
		...
		*/
		...
		var Market_module_css_default = {
			"act": "_6-jWBW_act",
			"actBroken": "_6-jWBW_actBroken",
			"actLive": "_6-jWBW_actLive",
			"actWarn": "_6-jWBW_actWarn",
			"actWhy": "_6-jWBW_actWhy",
			"assignRow": "_6-jWBW_assignRow",
			"assignSelect": "_6-jWBW_assignSelect",
			"av": "_6-jWBW_av",
			"backupActions": "_6-jWBW_backupActions",
			"backupCard": "_6-jWBW_backupCard",
			"backupCheck": "_6-jWBW_backupCheck",
			"backupCheckList": "_6-jWBW_backupCheckList",
			"backupGrid": "_6-jWBW_backupGrid",
			"backupInput": "_6-jWBW_backupInput",
			"backupMessage": "_6-jWBW_backupMessage",
			"backupWarn": "_6-jWBW_backupWarn",
			"banner": "_6-jWBW_banner",
			"bannerHint": "_6-jWBW_bannerHint",
			"bannerIcon": "_6-jWBW_bannerIcon",
			"bar": "_6-jWBW_bar",
			"barFill": "_6-jWBW_barFill",
			"barWave": "_6-jWBW_barWave",
			"body": "_6-jWBW_body",
			"byline": "_6-jWBW_byline",
			"card": "_6-jWBW_card",
			"cardAction": "_6-jWBW_cardAction",
			"cardBlocked": "_6-jWBW_cardBlocked",
			"cardBlockedMark": "_6-jWBW_cardBlockedMark",
			"cardShot": "_6-jWBW_cardShot",
			"cardShots": "_6-jWBW_cardShots",
			"cats": "_6-jWBW_cats",
			"catsCollapsed": "_6-jWBW_catsCollapsed",
			"catsRow": "_6-jWBW_catsRow",
			"catsToggle": "_6-jWBW_catsToggle",
			"catsWrap": "_6-jWBW_catsWrap",
			"choice": "_6-jWBW_choice",
			"choiceMain": "_6-jWBW_choiceMain",
			"choiceNote": "_6-jWBW_choiceNote",
			"choiceOn": "_6-jWBW_choiceOn",
			"choiceRadio": "_6-jWBW_choiceRadio",
			"choices": "_6-jWBW_choices",
			"choiceSafe": "_6-jWBW_choiceSafe",
			"choiceTitle": "_6-jWBW_choiceTitle",
			"cmd": "_6-jWBW_cmd",
			"collapseBody": "_6-jWBW_collapseBody",
			"collapseHead": "_6-jWBW_collapseHead",
			"collapseIcon": "_6-jWBW_collapseIcon",
			"collapseTitle": "_6-jWBW_collapseTitle",
			"commentsError": "_6-jWBW_commentsError",
			"commentsFail": "_6-jWBW_commentsFail",
			"commentsLink": "_6-jWBW_commentsLink",
			"commentsMount": "_6-jWBW_commentsMount",
			"commentsNote": "_6-jWBW_commentsNote",
			"commentsStatus": "_6-jWBW_commentsStatus",
			"confirmRow": "_6-jWBW_confirmRow",
			"conflictBody": "_6-jWBW_conflictBody",
			"conflictDetailsToggle": "_6-jWBW_conflictDetailsToggle",
			"conflictHead": "_6-jWBW_conflictHead",
			"conflictIcon": "_6-jWBW_conflictIcon",
			"conflictTitle": "_6-jWBW_conflictTitle",
			"conflictWhy": "_6-jWBW_conflictWhy",
			"conflictWhyText": "_6-jWBW_conflictWhyText",
			"dangerArmed": "_6-jWBW_dangerArmed",
			"dangerBtn": "_6-jWBW_dangerBtn",
			"depBadge": "_6-jWBW_depBadge",
			"depLine": "_6-jWBW_depLine",
			"deprecate": "_6-jWBW_deprecate",
			"desc": "_6-jWBW_desc",
			"descClamp": "_6-jWBW_descClamp",
			"descTight": "_6-jWBW_descTight",
			"descToggle": "_6-jWBW_descToggle",
			"diagAlert": "_6-jWBW_diagAlert",
			"diagArrow": "_6-jWBW_diagArrow",
			"diagBadgeCommunity": "_6-jWBW_diagBadgeCommunity",
			"diagBadgeInfo": "_6-jWBW_diagBadgeInfo",
			"diagBadgeOfficial": "_6-jWBW_diagBadgeOfficial",
			"diagBadgeShadow": "_6-jWBW_diagBadgeShadow",
			"diagBadgeWarn": "_6-jWBW_diagBadgeWarn",
			"diagBundle": "_6-jWBW_diagBundle",
			"diagCount": "_6-jWBW_diagCount",
			"diagEmpty": "_6-jWBW_diagEmpty",
			"diagIndex": "_6-jWBW_diagIndex",
			"diagKey": "_6-jWBW_diagKey",
			"diagList": "_6-jWBW_diagList",
			"diagMeta": "_6-jWBW_diagMeta",
			"diagPage": "_6-jWBW_diagPage",
			"diagRow": "_6-jWBW_diagRow",
			"diagSection": "_6-jWBW_diagSection",
			"diagSummary": "_6-jWBW_diagSummary",
			"diagSummaryItem": "_6-jWBW_diagSummaryItem",
			"diagSummaryMeta": "_6-jWBW_diagSummaryMeta",
			"diagVal": "_6-jWBW_diagVal",
			"dot": "_6-jWBW_dot",
			"dragging": "_6-jWBW_dragging",
			"dragHandle": "_6-jWBW_dragHandle",
			"dragOver": "_6-jWBW_dragOver",
			"dshmPlug": "_6-jWBW_dshmPlug",
			"dshmPlugFade": "_6-jWBW_dshmPlugFade",
			"dshmSlide": "_6-jWBW_dshmSlide",
			"empty": "_6-jWBW_empty",
			"err": "_6-jWBW_err",
			"exportLogBtn": "_6-jWBW_exportLogBtn",
			"fixFallback": "_6-jWBW_fixFallback",
			"fixFallbackText": "_6-jWBW_fixFallbackText",
			"foot": "_6-jWBW_foot",
			"grid": "_6-jWBW_grid",
			"groupActions": "_6-jWBW_groupActions",
			"groupAddPanel": "_6-jWBW_groupAddPanel",
			"groupCreate": "_6-jWBW_groupCreate",
			"groupHead": "_6-jWBW_groupHead",
			"groupHint": "_6-jWBW_groupHint",
			"groupMember": "_6-jWBW_groupMember",
			"groupMembers": "_6-jWBW_groupMembers",
			"groupName": "_6-jWBW_groupName",
			"groupRow": "_6-jWBW_groupRow",
			"grow": "_6-jWBW_grow",
			"head": "_6-jWBW_head",
			"hiddenFile": "_6-jWBW_hiddenFile",
			"inlineInput": "_6-jWBW_inlineInput",
			"installBtn": "_6-jWBW_installBtn",
			"irow": "_6-jWBW_irow",
			"irowActions": "_6-jWBW_irowActions",
			"irowMissing": "_6-jWBW_irowMissing",
			"irowName": "_6-jWBW_irowName",
			"irowNameText": "_6-jWBW_irowNameText",
			"irowTrailing": "_6-jWBW_irowTrailing",
			"lightbox": "_6-jWBW_lightbox",
			"lightboxClose": "_6-jWBW_lightboxClose",
			"lightboxDot": "_6-jWBW_lightboxDot",
			"lightboxDotOn": "_6-jWBW_lightboxDotOn",
			"lightboxDots": "_6-jWBW_lightboxDots",
			"lightboxImg": "_6-jWBW_lightboxImg",
			"lightboxNav": "_6-jWBW_lightboxNav",
			"lightboxNext": "_6-jWBW_lightboxNext",
			"lightboxPrev": "_6-jWBW_lightboxPrev",
			"loading": "_6-jWBW_loading",
			"logoMark": "_6-jWBW_logoMark",
			"logoPlug": "_6-jWBW_logoPlug",
			"masonry": "_6-jWBW_masonry",
			"masonryCol": "_6-jWBW_masonryCol",
			"meta": "_6-jWBW_meta",
			"metaInline": "_6-jWBW_metaInline",
			"metaTag": "_6-jWBW_metaTag",
			"metaTagOk": "_6-jWBW_metaTagOk",
			"modalNote": "_6-jWBW_modalNote",
			...
			"noteRow": "_6-jWBW_noteRow",
			"notesArrow": "_6-jWBW_notesArrow",
			"notesBody": "_6-jWBW_notesBody",
			"notesCode": "_6-jWBW_notesCode",
			"notesDate": "_6-jWBW_notesDate",
			"notesH": "_6-jWBW_notesH",
			"notesLink": "_6-jWBW_notesLink",
			"notesList": "_6-jWBW_notesList",
			"notesMeta": "_6-jWBW_notesMeta",
			"notesMsg": "_6-jWBW_notesMsg",
			"notesP": "_6-jWBW_notesP",
			"notesPre": "_6-jWBW_notesPre",
			"notesRange": "_6-jWBW_notesRange",
			"notesRendered": "_6-jWBW_notesRendered",
			"notesRow": "_6-jWBW_notesRow",
			"notesSha": "_6-jWBW_notesSha",
			"notesVer": "_6-jWBW_notesVer",
			"noteToggle": "_6-jWBW_noteToggle",
			"okState": "_6-jWBW_okState",
			"on": "_6-jWBW_on",
			"opActions": "_6-jWBW_opActions",
			"opAggregate": "_6-jWBW_opAggregate",
			"opAggregateHint": "_6-jWBW_opAggregateHint",
			"opAggregateTop": "_6-jWBW_opAggregateTop",
			"opCloseBtn": "_6-jWBW_opCloseBtn",
			"opDecision": "_6-jWBW_opDecision",
			"opDecisionFoot": "_6-jWBW_opDecisionFoot",
			"opDot": "_6-jWBW_opDot",
			"opEmpty": "_6-jWBW_opEmpty",
			"opEmptyHint": "_6-jWBW_opEmptyHint",
			"opEntry": "_6-jWBW_opEntry",
			"opEntryAlert": "_6-jWBW_opEntryAlert",
			"opEntryQuiet": "_6-jWBW_opEntryQuiet",
			"opHead": "_6-jWBW_opHead",
			"opIcon": "_6-jWBW_opIcon",
			"opMain": "_6-jWBW_opMain",
			"opName": "_6-jWBW_opName",
			"opPanel": "_6-jWBW_opPanel",
			"opPanelTitle": "_6-jWBW_opPanelTitle",
			"opQueuedIcon": "_6-jWBW_opQueuedIcon",
			"opRow": "_6-jWBW_opRow",
			"opRowAlert": "_6-jWBW_opRowAlert",
			"opStatus": "_6-jWBW_opStatus",
			"opStatusBad": "_6-jWBW_opStatusBad",
			"opTop": "_6-jWBW_opTop",
			"opVerb": "_6-jWBW_opVerb",
			"opWrap": "_6-jWBW_opWrap",
			"orderPanel": "_6-jWBW_orderPanel",
			"orphBadge": "_6-jWBW_orphBadge",
			"orphRow": "_6-jWBW_orphRow",
			"ovArrow": "_6-jWBW_ovArrow",
			"ovByTag": "_6-jWBW_ovByTag",
			"ovFrom": "_6-jWBW_ovFrom",
			"ovRow": "_6-jWBW_ovRow",
			"owner": "_6-jWBW_owner",
			"pageEllipsis": "_6-jWBW_pageEllipsis",
			"pageInfo": "_6-jWBW_pageInfo",
			"pager": "_6-jWBW_pager",
			"pagerPages": "_6-jWBW_pagerPages",
			"panelActions": "_6-jWBW_panelActions",
			"panelNote": "_6-jWBW_panelNote",
			"pct": "_6-jWBW_pct",
			"presetList": "_6-jWBW_presetList",
			"presetName": "_6-jWBW_presetName",
			"presetRow": "_6-jWBW_presetRow",
			"progress": "_6-jWBW_progress",
			"reassure": "_6-jWBW_reassure",
			"reassureOk": "_6-jWBW_reassureOk",
			"repoLink": "_6-jWBW_repoLink",
			"repoMark": "_6-jWBW_repoMark",
			"retryBtn": "_6-jWBW_retryBtn",
			"root": "_6-jWBW_root",
			"roster": "_6-jWBW_roster",
			"rosterAuthor": "_6-jWBW_rosterAuthor",
			"rosterMain": "_6-jWBW_rosterMain",
			"rosterName": "_6-jWBW_rosterName",
			"rosterRow": "_6-jWBW_rosterRow",
			"rosterRowOut": "_6-jWBW_rosterRowOut",
			"rosterSplit": "_6-jWBW_rosterSplit",
			"rosterTag": "_6-jWBW_rosterTag",
			"rosterTagDrop": "_6-jWBW_rosterTagDrop",
			"rosterTagKeep": "_6-jWBW_rosterTagKeep",
			"row1": "_6-jWBW_row1",
			"sectAction": "_6-jWBW_sectAction",
			"sectionOverview": "_6-jWBW_sectionOverview",
			"setActions": "_6-jWBW_setActions",
			"setBetaTag": "_6-jWBW_setBetaTag",
			"setBody": "_6-jWBW_setBody",
			"setCard": "_6-jWBW_setCard",
			"setCardOpen": "_6-jWBW_setCardOpen",
			"setCheck": "_6-jWBW_setCheck",
			"setChevron": "_6-jWBW_setChevron",
			"setChevronOpen": "_6-jWBW_setChevronOpen",
			"setConfirm": "_6-jWBW_setConfirm",
			"setDanger": "_6-jWBW_setDanger",
			"setDesc": "_6-jWBW_setDesc",
			"setHeader": "_6-jWBW_setHeader",
			"setHeadText": "_6-jWBW_setHeadText",
			"setHint": "_6-jWBW_setHint",
			"setLabel": "_6-jWBW_setLabel",
			"setLabelBox": "_6-jWBW_setLabelBox",
			"setName": "_6-jWBW_setName",
			"setRow": "_6-jWBW_setRow",
			"setSeg": "_6-jWBW_setSeg",
			"setSegBtn": "_6-jWBW_setSegBtn",
			"setSegOn": "_6-jWBW_setSegOn",
			"shot": "_6-jWBW_shot",
			"shots": "_6-jWBW_shots",
			"snapConfirmText": "_6-jWBW_snapConfirmText",
			"snapList": "_6-jWBW_snapList",
			"snapMeta": "_6-jWBW_snapMeta",
			"snapRow": "_6-jWBW_snapRow",
			"sp": "_6-jWBW_sp",
			"spec": "_6-jWBW_spec",
			"specTag": "_6-jWBW_specTag",
			"specTagFile": "_6-jWBW_specTagFile",
			"specTagGit": "_6-jWBW_specTagGit",
			"spin": "_6-jWBW_spin",
			"src": "_6-jWBW_src",
			"srcBadge": "_6-jWBW_srcBadge",
			"srcOk": "_6-jWBW_srcOk",
			"srcWarn": "_6-jWBW_srcWarn",
			"staleAction": "_6-jWBW_staleAction",
			"star": "_6-jWBW_star",
			"stateDot": "_6-jWBW_stateDot",
			"stateTag": "_6-jWBW_stateTag",
			"stickyHead": "_6-jWBW_stickyHead",
			"sub": "_6-jWBW_sub",
			"submitLink": "_6-jWBW_submitLink",
			"subTabs": "_6-jWBW_subTabs",
			"swatches": "_6-jWBW_swatches",
			"switch": "_6-jWBW_switch",
			"switchKnob": "_6-jWBW_switchKnob",
			"switchMixed": "_6-jWBW_switchMixed",
			"switchOn": "_6-jWBW_switchOn",
			"tab": "_6-jWBW_tab",
			"tabs": "_6-jWBW_tabs",
			"tabSearch": "_6-jWBW_tabSearch",
			"tabSearchRow": "_6-jWBW_tabSearchRow",
			"tag": "_6-jWBW_tag",
			"themeActions": "_6-jWBW_themeActions",
			"themeCard": "_6-jWBW_themeCard",
			"themeCardBody": "_6-jWBW_themeCardBody",
			"themeCardFooter": "_6-jWBW_themeCardFooter",
			"themeCardHead": "_6-jWBW_themeCardHead",
			"themeCover": "_6-jWBW_themeCover",
			"themeCoverEmpty": "_6-jWBW_themeCoverEmpty",
			"themeDescription": "_6-jWBW_themeDescription",
			"themeFeatured": "_6-jWBW_themeFeatured",
			"themeFeaturedActions": "_6-jWBW_themeFeaturedActions",
			"themeFeaturedBadge": "_6-jWBW_themeFeaturedBadge",
			"themeFeaturedBody": "_6-jWBW_themeFeaturedBody",
			"themeFeaturedCover": "_6-jWBW_themeFeaturedCover",
			"themeFeaturedHead": "_6-jWBW_themeFeaturedHead",
			"themeFeaturedNote": "_6-jWBW_themeFeaturedNote",
			"themeFullscreenBtn": "_6-jWBW_themeFullscreenBtn",
			"themeGallery": "_6-jWBW_themeGallery",
			"themeIdentity": "_6-jWBW_themeIdentity",
			"themeLifecycle": "_6-jWBW_themeLifecycle",
			"themePreviewAction": "_6-jWBW_themePreviewAction",
			"themePreviewCount": "_6-jWBW_themePreviewCount",
			"themeResultBar": "_6-jWBW_themeResultBar",
			"themeSearch": "_6-jWBW_themeSearch",
			"themesGrid": "_6-jWBW_themesGrid",
			"themeStatus": "_6-jWBW_themeStatus",
			"themeStatusMuted": "_6-jWBW_themeStatusMuted",
			"themeTags": "_6-jWBW_themeTags",
			"themeToolbar": "_6-jWBW_themeToolbar",
			"themeToolbarActions": "_6-jWBW_themeToolbarActions",
			"themeTryOnBadge": "_6-jWBW_themeTryOnBadge",
			"title": "_6-jWBW_title",
			"titleRow": "_6-jWBW_titleRow",
			"top": "_6-jWBW_top",
			"topBtn": "_6-jWBW_topBtn",
			"version": "_6-jWBW_version",
			"viewBar": "_6-jWBW_viewBar",
			"viewBtn": "_6-jWBW_viewBtn",
			"viewOn": "_6-jWBW_viewOn",
			"warnLine": "_6-jWBW_warnLine"
		};
		//#endregion
		...
		* purpose so the helper needs no RegistryPlugin import in this component. */
		function sourceBadge(p) {
			...
			if (typeof p.url === "string" && /\/tree\//.test(p.url)) return {
				key: "badgeSubpath",
				tone: "warn"
			};
			return {
		...
		function MarketSection(props) {
			...
			* search or sort choice in one tab has no business resetting the other. */
			...
			const [themeTag, setThemeTag] = (0, react.useState)("all");
			...
			* differently: "there's nothing here yet" vs "nothing matches your filter". */
										...
										children: [
											...
											(() => {
												...
												return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: sb.tone === "ok" ? `${Market_module_css_default.srcBadge} ${Market_module_css_default.srcOk}` : `${Market_module_css_default.srcBadge} ${Market_module_css_default.srcWarn}`,
													title: t(sb.key),
													children: t(sb.key)
												});
											})()
			...
			const tryOnVarsRef = (0, react.useRef)(null);
			const tryOnTimerRef = (0, react.useRef)(null);
			const applyTryOn = (def) => {
				...
				if (def === null || def.tokens === void 0) return;
				const keys = [];
			...
			const scheduleTryOn = (def) => {
				if (tryOnTimerRef.current !== null) {
					clearTimeout(tryOnTimerRef.current);
			...
			const tryOnDefOf = (p) => {
				...
				return themeSnap.themes.find((def) => {
					...
					if (def.tokens === void 0) return false;
			...
			const themePluginCard = (p) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThemeCover, {
							plugin: p,
							onOpen: openLightbox,
							t
						}),
						tryOnDef !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: Market_module_css_default.themeTryOnBadge,
							children: t("themeTryOn")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
										...
										target: "_blank",
										rel: "noreferrer",
										title: BRAND.repoTitle,
										children: BRAND.displayNameEn
									}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: tab === "backup" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							(() => {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: Market_module_css_default.themeTags,
									role: "group",
									"aria-label": t("themeTagsLabel"),
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Pill, {
										active: themeTag === "all",
										onClick: () => setThemeTag("all"),
										children: t("all")
									}), tags.map((tag) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Pill, {
										active: themeTag === tag,
										onClick: () => setThemeTag(tag),
										children: t("themeTag" + tag[0].toUpperCase() + tag.slice(1))
									}, tag))]
								});
							})(),
							data !== null && (() => {
								...
								const fMounted = fInst !== null && (skins.includes(fInst) || bootEntries.some((e) => e.id === fInst)) && !effectiveDisabledSet.has(fInst);
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: Market_module_css_default.themeFeatured,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										className: Market_module_css_default.themeFeaturedCover,
										...
										className: Market_module_css_default.themeFeaturedBody,
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												className: Market_module_css_default.themeFeaturedHead,
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
														className: Market_module_css_default.themeFeaturedBadge,
														children: [
															/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconSparkle16, { size: 12 }),
															" ",
															t("themeFeatured")
														]
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("a", {
														...
														rel: "noreferrer",
														title: fp.name,
														"aria-label": `${fp.name} — ${t("repoLink")}`,
														children: [pluginName(fp.name), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLinkOutline14, {
															size: 12,
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
												className: Market_module_css_default.themeFeaturedNote,
												children: featured.note[lang] || featured.note.en
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: Market_module_css_default.themeFeaturedActions,
												children: fInst === null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
													variant: "primary",
													size: "sm",
													onClick: () => setConfirming(fp),
													children: t("install")
												}) : fMounted ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													className: Market_module_css_default.okState,
													children: t("themeActive")
												}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
													variant: "primary",
													size: "sm",
													onClick: () => doUseSkin(fInst),
													children: t("themeApply")
												})
											})
										]
							...
							data === null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								className: Market_module_css_default.empty,
								children: themeTag !== "all" && qThemes.trim() === "" ? t("themeTagEmpty") : t("empty")
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
