...
- **Themes** — a dedicated tab for community themes and skins: a weekly featured pick, style tags (dark/light/glass/minimal/retro/anime/wallpaper…), and **hover-to-try-on** — the whole UI wears the theme while your pointer is on the card, and moving away restores it without touching your chosen theme. Install → active immediately, switch with one click (themes are mutually exclusive, your choice survives restarts), uninstall to revert
